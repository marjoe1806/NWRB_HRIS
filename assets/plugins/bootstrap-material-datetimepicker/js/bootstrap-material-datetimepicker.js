                 ...
                 for (var i = 0; i < calendar.days.length; i++)
                 {
                    ...
                    if (calendar.days[i] != 0)
                    {
                     //   if (this.isBeforeMaxDate(moment(calendar.days[i]), false, false) === false || this.isAfterMinDate(moment(calendar.days[i]), false, false) === false)
                       if (this.isBeforeMaxDate(moment(calendar.days[i]), false, false) === false || this.isAfterMinDate(moment(calendar.days[i]), false, false) === false || ((this.params.disabledDays) && this.params.disabledDays.indexOf(calendar.days[i].isoWeekday()) !== -1) || ((this.params.disabledDates) && this.params.disabledDates.indexOf(moment(calendar.days[i]).locale(this.params.lang).format('YYYY-MM-DD')) !== -1))
                       {
