                  ...
                  for (var styles in defaults.excelstyles) {
                    if (defaults.excelstyles.hasOwnProperty(styles)) {
                      ...
                      if (tdcss != "" && tdcss != "0px none rgb(0, 0, 0)") {
                        if (tdstyle == "") tdstyle = 'style="';
                        tdstyle +=
                          defaults.excelstyles[styles] + ":" + tdcss + ";";
                      }
                    }
                  }
            ...
            .each(function () {
              ...
              if (typeof atOptions.createdHeaderCell !== "function") {
                ...
                atOptions.createdHeaderCell = function (cell, data) {
                  ...
                  if (
                    typeof teOptions.columns[data.column.dataKey] != "undefined"
                  ) {
              ...
              if (rowIndex > 0) {
                ...
                $.each(teOptions.headerrows[rowIndex - 1], function () {
                  ...
                  if (obj != null) teOptions.columns.push(obj);
                });
              }
          ...
          var $row = $(tableRow)
            .filter(function () {
              return (
                ...
                ($(this).is(":visible") ||
                  $(this).data("tableexport-display") == "always" ||
                  $(this).closest("table").data("tableexport-display") ==
                    "always")
              );
            })
            .find(selector);
            ...
            if (
              ...
              if (isColumnIgnored($row, colIndex) == false) {
                if (typeof cellcallback === "function") {
                  ...
                  if (
                    typeof rowspans[rowIndex] != "undefined" &&
