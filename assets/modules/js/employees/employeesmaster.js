...
var getEmployees = { 
    activate : function() {
        var temp = null;
        // url2 = commons.baseurl + "employees/Employees/getActiveEmployees"; //Modified by Jomer to connect direct to payroll db. 
        url2 = commons.baseurl + "employees/Employees/getActiveEmployeesJomer";
        $.ajax({
            async: false,
            url: url2,
            type:'POST',
