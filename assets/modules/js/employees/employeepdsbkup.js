                  ...
                  $.each(result.Data.workexperience, function (k, v) {
                    ...
                    $("#tbworkexp").append(
                      "<tr>" +
                        ...
                        '     <input type="text" value="' + v.work_to + '" class="form-control is_third_col_required date_mask '+(v.work_to == "PRESENT" ? 'remove_date_format':'')+'" name="work_to[' + k + ']" id="work_to[' + k + ']" >'+
                        '    </div></div>' +
                        '    <div class="form-group">'+
                  ...
                  $.each(result.Data.learningdevelopment, function (
                    ...
                    $("#tblearnings").append(
                      "<tr>" +
                        ...
                        "</textarea></div></div></td>" +
                        ' <th><button type="button" class="btn btn-danger btn-sm deleteRow" style="float: right"><i class="material-icons">remove</i></button><button type="button" class="btn btn-primary btn-sm addRow" style="float: right"><i class="material-icons">add</i></button></th>' +
                        "</tr>"
                    );
                  });
                }
...
function init_form_wizard() {
  ...
  pdsform.validate({
    ...
    rules: {
      ...
      last_name: { required: true, lastnameRegex: true },
      first_name: { required: true, firstnameRegex: true},
      middle_name: { middlenameRegex: true },
  ...
  $.validator.addMethod(
      ...
      "Letters, dashes and period only"
    );
