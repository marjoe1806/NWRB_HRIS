					...
					yes: {
						...
						action: function() {
							...
							$.ajax({
								...
								url:
									commons.baseurl +
									"OvertimeServiceRendered/DailyTimeRecordSummary/checkPost",
								data: "",
								dataType: "json",
								success: function(result) {
									...
									$.each(employee_id, function(key, value) {
										...
										$.ajax({
											...
											url:
												commons.baseurl +
												"OvertimeServiceRendered/DailyTimeRecordSummary/fetchRowsSummary" +
												plus_url,
											dataType: "json",
											success: function(result) {
			...
			success: function(result) {
				...
				table = $("#datatables").DataTable({
					...
					ajax: {
						url:
							commons.baseurl +
							"OvertimeServiceRendered/DailyTimeRecordSummary/fetchRows" +
							plus_url,
						type: "POST"
					},
					columnDefs: [
				...
				button =
					...
					commons.baseurl +
					'OvertimeServiceRendered/DailyTimeRecordSummary/viewDailyTimeRecordSummaryAll">' +
