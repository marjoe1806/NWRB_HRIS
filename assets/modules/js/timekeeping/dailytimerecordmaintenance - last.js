				...
				if (result.hasOwnProperty("key")) {
					switch (result.key) {
						...
						case 'updateDailyTimeRecordMaintenance':
							...
							if($(".adjustment_am_arrival").val() == "") {
								$(".adjustment_am_arrival").val(my.data('actual_am_arrival'))
							}
							if($(".adjustment_am_departure").val() == "") {
								$(".adjustment_am_departure").val(my.data('actual_am_departure'))
							}
							if($(".adjustment_pm_arrival").val() == "") {
								$(".adjustment_pm_arrival").val(my.data('actual_pm_arrival'))
							}
							if($(".adjustment_pm_departure").val() == "") {
								$(".adjustment_pm_departure").val(my.data('actual_pm_departure'))
							}
							break;
					}
					$("#" + result.key).validate({
