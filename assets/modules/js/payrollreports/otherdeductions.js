$(function(){
    ...
    //Ajax non-forms
    $(document).on('click','#viewOtherDeductionsSummary',function(e){
        e.preventDefault();
        my = $(this)
        url = my.attr('href');
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.hasOwnProperty("key")){
                    switch(result.key){
                        case 'viewOtherDeductionsSummary':
                            page="";
                            $('#myModal .modal-dialog').attr('class','modal-dialog modal-lg');
                            modal_title = "Other Deductions Summary"
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                table = $('#datatables').DataTable({  
                       ...
                       "order":[],  
                       "ajax":{  
                            url:commons.baseurl+ "payrollreports/OtherDeductions/fetchRows"+plus_url,  
                            type:"POST"  
                       },  
                       "columnDefs":[  
                            {  
                ...
                button =    '<a id="viewOtherDeductionsSummary" href="'+commons.baseurl+'payrollreports/OtherDeductions/viewOtherDeductionsSummary">'
                            +    '<button type="button" class="btn btn-block btn-lg btn-success waves-effect">'
                            +        '<i class="material-icons">description</i> Other  Deductions Summary'
                            +    '</button>'
                            +'</a>'
