$(function(){
    ...
    //Ajax non-forms
    $(document).on('click','#viewLoanDeductionsSummary',function(e){
        e.preventDefault();
        my = $(this)
        url = my.attr('href');
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.hasOwnProperty("key")){
                    switch(result.key){
                        case 'viewLoanDeductionsSummary':
                            page="";
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                table = $('#datatables').DataTable({  
                       ...
                       "order":[],  
                       "ajax":{  
                            url:commons.baseurl+ "payrollreports/LoanDeductions/fetchRows"+plus_url,  
                            type:"POST"  
                       },  
                       "columnDefs":[  
                            {  
                ...
                button =    '<a id="viewLoanDeductionsSummary" href="'+commons.baseurl+'payrollreports/LoanDeductions/viewLoanDeductionsSummary">'
                            +    '<button type="button" class="btn btn-block btn-lg btn-success waves-effect">'
                            +        '<i class="material-icons">description</i> Loan  Deductions Summary'
                            +    '</button>'
                            +'</a>'
