$(function(){
                ...
                confirm: {
                    ...
                    action: function () {
                        ...
                        if(total_data > 0){
                            ...
                            $.ajax({
                                type: "POST",
                                url: commons.baseurl+ "payrollreports/SalaryIndexCard/payslipContainer",
                                dataType: "json",
                                success: function(result){
                                    if(result.hasOwnProperty("key")){
                                        switch(result.key){
    ...
    function getEmployeeSalaryIndexCard(payroll_period_id,employee_id,queue){
        url2 = commons.baseurl+ "payrollreports/SalaryIndexCard/viewSalaryIndexCardSummary/";
        $.ajax({
            type: "POST",
            url: url2,
            async:false,
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                table = $('#datatables').DataTable({  
                       ...
                       "order":[],  
                       "ajax":{  
                            url:commons.baseurl+ "payrollreports/SalaryIndexCard/fetchRows"+plus_url,  
                            type:"POST"  
                       },  
                       "columnDefs":[  
                            {  
                ...
                // button =    '<a id="viewSalaryIndexCardSummary" href="'+commons.baseurl+'payrollreports/SalaryIndexCard/viewSalaryIndexCardSummary">'
