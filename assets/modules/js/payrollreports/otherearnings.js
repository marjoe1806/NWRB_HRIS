$(function(){
    ...
    //Ajax non-forms
    $(document).on('click','#viewOtherEarningsSummary',function(e){
        e.preventDefault();
        my = $(this)
        url = my.attr('href');
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.hasOwnProperty("key")){
                    switch(result.key){
                        case 'viewOtherEarningsSummary':
                            page="";
                            $('#myModal .modal-dialog').attr('class','modal-dialog modal-lg');
                            modal_title = "Other Earnings Summary"
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                table = $('#datatables').DataTable({  
                       ...
                       "order":[],  
                       "ajax":{  
                            url:commons.baseurl+ "payrollreports/OtherEarnings/fetchRows"+plus_url,  
                            type:"POST"  
                       },  
                       "columnDefs":[  
                            {  
                ...
                button =    '<a id="viewOtherEarningsSummary" href="'+commons.baseurl+'payrollreports/OtherEarnings/viewOtherEarningsSummary">'
                            +    '<button type="button" class="btn btn-block btn-lg btn-success waves-effect">'
                            +        '<i class="material-icons">description</i> Other  Earnings Summary'
                            +    '</button>'
                            +'</a>'
