$(document).ready(function () {
	...
	$(document).on("click", "#viewGSISContributionSummary", function (e) {
		e.preventDefault();
		my = $(this);
		url = my.attr("href");
		...
		// }  else if (week_period == "" && pay_basis == "Permanent") {
			...
			modal_title = "GSIS REMITTANCE REPORT";
			...
			$.ajax({
				...
				url:
					commons.baseurl +
					"remittance/GSISContribution/viewGSISContributionSummary",
				data: {
				...
				success: function (result) {
					...
					if (result.hasOwnProperty("key")) {
						switch (result.key) {
							case "viewGSISContributionSummary":
								page = "";
