$(document).ready(function () {
	...
	$(document).on("click", "#viewPhilHealthSummary", function (e) {
		e.preventDefault();
		my = $(this);
		url = my.attr("href");
		...
		// }  else if (week_period == "" && pay_basis == "Permanent") {
			...
			modal_title = "PHILHEALTH REMITTANCE REPORT";
			...
			$.ajax({
				...
				url:
					commons.baseurl +
					"remittance/PhilHealth/viewPhilHealthSummary",
				data: {
