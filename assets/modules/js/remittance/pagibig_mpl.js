$(document).ready(function () {
	...
	$(document).on("click", "#viewPagibigMPLSummary", function (e) {
		e.preventDefault();
		my = $(this);
		url = my.attr("href");
		...
		// }  else if (week_period == "" && pay_basis == "Permanent") {
			...
			modal_title = "PAG-IBIG MPL REMITTANCE REPORT";
			...
			$.ajax({
				...
				url:
					commons.baseurl +
					"remittance/PagibigMPL/viewPagibigMPLSummary",
				data: {
