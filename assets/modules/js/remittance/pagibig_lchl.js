$(document).ready(function () {
	...
	$(document).on("click", "#viewPagibigLCHLSummary", function (e) {
		e.preventDefault();
		my = $(this);
		url = my.attr("href");
		...
		// }  else if (week_period == "" && pay_basis == "Permanent") {
			...
			modal_title = "PAG-IBIG HOUSING LOAN/LCHL REMITTANCE REPORT";
			...
			$.ajax({
				...
				url:
					commons.baseurl +
					"remittance/PagibigLCHL/viewPagibigLCHLSummary",
				data: {
