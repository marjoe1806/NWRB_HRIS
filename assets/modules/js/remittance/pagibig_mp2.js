$(document).ready(function () {
	...
	$(document).on("click", "#viewPagibigMP2Summary", function (e) {
		e.preventDefault();
		my = $(this);
		url = my.attr("href");
		...
		// }  else if (week_period == "" && pay_basis == "Permanent") {
			...
			modal_title = "PAG-IBIG MP2 REMITTANCE REPORT";
			...
			$.ajax({
				...
				url:
					commons.baseurl +
					"remittance/PagibigMP2/viewPagibigMP2Summary",
				data: {
