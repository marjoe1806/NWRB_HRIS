$(document).ready(function(){
    ...
    function ipcr_reviews(){
        $('#ipcr_reviews').DataTable({
            ...
            ajax:
             {
                url: baseURL + "performancemanagement/IpcrApproval/get_ipcr",
                type: "POST"
             },
            columns: [
                {
    ...
    $(document).on("click", ".view", function (e) {
        ...
        var url = baseURL + 'performancemanagement/IpcrApproval/view_ipcr';
    ...
    $(document).on("click", ".approve", function (e) {
        ...
        var url = baseURL + 'performancemanagement/IpcrApproval/approve';
        var data = {
