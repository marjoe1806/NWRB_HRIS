$(document).ready(function(){
    ...
    function ipcr_reviews(){
        $('#ipcr_reviews').DataTable({
            ...
            ajax: {
                url : baseURL + "performancemanagement/IpcrValidate/get_ipcr",
                type: "POST"
            },
            columns: [
                {
    ...
    $(document).on("click", ".view", function (e) {
        ...
        var url = baseURL + 'performancemanagement/IpcrValidate/view_ipcr';
    ...
    $(document).on("click", ".validate", function (e) {
        ...
        var url = baseURL + 'performancemanagement/IpcrValidate/validate';
        var data = {
