$(document).ready(function(){
    ...
    function opcr_reviews(){
        $('#opcr_reviews').DataTable({
            ...
            // ajax: baseURL + "opcrfinalrating/get_opcr",
            ajax: {
                url: baseURL + "performancemanagement/OpcrFinalRating/get_opcr",
                type: "POST"
            },
            columns: [
                {
                ...
                },
                {
                    "data": function (data) {
                        ...
                        //         data-id = "`+data.form_id+`" data-final_rating = "`+data.final_rating+`"
                        //     >
                        ...
                        return `
                            <button class="btn btn-success btn-circle waves-effect waves-circle waves-float pull-right view" 
                                    ...
                                    data-final_rating = "${data.final_rating}"
                                    data-toggle="tooltip" 
                                    data-placement="top" 
                                    title="" 
    ...
    $(document).on("click", ".view", function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var final_rating = $(this).data('final_rating');
        var url = baseURL + 'performancemanagement/OpcrFinalRating/view_opcr';
    ...
    $(document).on("click", ".approve", function (e) {
        ...
        var url = baseURL + 'performancemanagement/OpcrFinalRating/approve';
        var data = {
