        ...
        <tbody>
            ...
            if(isset($list->Data->details) && sizeof($list->Data->details) > 0): 
                ...
                <tr>
                    ...
                    <td>
                        <a  id="updateForeignRecordForm" 
                            class="updateForeignRecordForm btn btn-info btn-circle waves-effect waves-circle waves-float"
                            href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/updateForeignRecordForm'; ?>"  data-toggle="tooltip" data-placement="top" title="Update" 
                        ...
                        <a  id="previewForeignRecord" 
                            class="previewForeignRecord btn btn-info btn-circle waves-effect waves-circle waves-float"
                            href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/previewForeignRecord'; ?>"  data-toggle="tooltip" data-placement="top" title="Preview" 
                            data-id="<?php echo $value->tm_id; ?>"
                            <?php foreach ($value as $k => $v) {
                                echo ' data-'.$k.'="'.$v.'" ';
                            } ?>"
