                ...
                <div class="row">
                    <div class="col-md-6">
                        <?php //if(Helper::role(ModuleRels::ADD_DIVISION)): ?>
                            <a id="addForeignRecordForm" style="text-decoration:none;" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/addForeignRecordForm'; ?>">
                                <button type="button" class="btn btn-info btn-lg waves-effect">
                                    <i class="material-icons">save</i>
                                    <span> Add Foreign Record</span>
                                </button>
                            </a>
                        <?php //endif; ?>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/trainingmonitoring/foreignrecord.js"></script>