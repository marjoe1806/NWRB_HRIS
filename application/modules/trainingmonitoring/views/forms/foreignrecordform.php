...
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    ...
    <div class="form-elements-container">
    	...
    	<?php if($key == "addForeignRecord" || $key == "updateForeignRecord"): ?>
    ...
    <div class="text-right" style="width:100%;">
    	<?php if($key == "addForeignRecord"): ?>
    		<button id="addForeignRecord" class="btn btn-primary btn-sm waves-effect" type="submit">
	            <i class="material-icons">add</i><span> Add</span>
	        </button>
    	<?php endif; ?>
    	<?php if($key == "updateForeignRecord" || $key == "changeUpload"): ?>
	        <button id="updateForeignRecord" class="btn btn-primary btn-sm waves-effect" type="submit">
