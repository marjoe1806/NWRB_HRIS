<style type="text/css">
   ...
   #dpcr_table_fourth .form-control{
   text-align: center;
   }
   /*#ipcr_table tr:nth-child(1) td{
   border: 0px;
   }*/
   #dpcr_table tr:nth-child(4) td table {
   border: 0px !important;
   }
   #dpcr_table_second tr td{
   border: 1px solid rgb(227,227,227);
   text-align: center;
   }
   #dpcr_table_second tr th{
   border: 1px solid rgb(227,227,227);
   text-align: center;
   padding: 5px;
   }
   #dpcr_table_second tbody td{
   padding: 8px;
   }
   #dpcr_table_second input[type="checkbox"]{
   width: 20px;
   }
   #dpcr_table_third tr td{
   border: 1px solid rgb(227,227,227);
   text-align: center;
   padding: 5px;
   }
   #dpcr_table_third label{
   color: rgb(136,136,136);
   font-size: 12px;
   }
   #dpcr_table_fourth tr td{
   border: 1px solid rgb(227,227,227);
   text-align: center;
   padding: 5px;
   }
   #dpcr_table_fourth label{
   color: rgb(136,136,136);
   font-size: 12px;
   }
   input:read-only {
   ...
   .table-style .form-group, #dpcr_table .form-group, #dpcr_table_second .form-group, #dpcr_table_fourth .form-group{
...
<div class="row clearfix" id="userLevelForm">
   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         ...
         <form id = "dpcr_form" style="font-size: 15px;">
            <div class="row">
                     ...
                     <td>
                        <div class="form-group">
                           <div class="form-line employee_select">
                              <select data-size="5" class="employee_id form-control" name="employee_id" id="employee_id" data-live-search="true" required>
                              ...
                              <select class="reviewed_by form-control" name="reviewed_by" id="reviewed_by" data-live-search="true" required>
                                 ...
                                 <?php foreach ($get_employee as $key => $value): ?>
                                    <option value="<?php echo $value->id ?>">
                                       <?php echo $value->emp_id.' - '.$value->empl_name; ?>
                                    </option>
                                 <?php endforeach; ?>
                              </select>
                           </div>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="dpcr_date form-control date_review " name="date_review" value = "<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                           </td>
                           <td>
                           ...
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="date_approve dpcr_date form-control is_first_col_required " name="date_approve" value = "<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                           </td>
                        </tr>
               ...
               <div class="content table-responsive table-full-width">
                  <table id = "dpcr_table_second" style="width: 100%;">
                     <thead>
                        <tr>
                           <th rowspan="2">
                     ...
                     <tbody>
                        <tr>
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <select data-size="5" class="discussed_with_emp form-control" name="discussed_with_emp" id="discussed_with_emp" data-live-search="true" required>
                                             <option></option>
                                             <?php foreach ($get_employee as $key => $value): ?>
                                                <option value="<?php echo $value->id ?>">
                                                <?php echo $value->emp_id.' - '.$value->f_name.' '.$value->m_name.' '.$value->l_name; ?>
                           ...
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="dpcr_date form-control date_discussed " name="date_discussed" value = "<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                           </td>
                           <td>
                           ...
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="dpcr_date date_assesed form-control is_first_col_required " name="date_assesed" value = "<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                           </td>
                           <td>
                           ...
                           <td>
                                 <div class="form-group">
                                    <div class="form-line">
                                       <input type="text" class="dpcr_date date_final_rating form-control is_first_col_required " name="date_final_rating" value = "<?php echo date('Y-m-d'); ?>" required>
                                    </div>
                                 </div>
                           </td>
                        </tr>
...
<script type="text/javascript" src = "<?php echo base_url(); ?>assets/modules/js/performancemanagement/dpcr.js"></script>