...
<div class = "container-fluid">
    <!-- <ol class="etapier">
        ...
        <li class="todo">
            <button type = "button" rel="tooltip" title = "View" class="btn btn-default btn-fill btn-social btn-round step2" title="">
                <i class="fa fa-file-text"></i>
            </button>
        </li>
        <li class="todo">
            <button type = "button" rel="tooltip" title = "Validate" class="btn btn-default btn-fill btn-social btn-round step3" title="">
                <i class="fa fa-thumbs-up"></i>
            </button>
        </li>
        <li class="todo">
            <button type = "button" rel="tooltip" title = "Approval" class="btn btn-default btn-fill btn-social btn-round step4" title="">
                <i class="fa fa-check"></i>
            </button>
        </li>
        <li class="todo">
            <button type = "button" rel="tooltip" title = "Final Approval" class="btn btn-default btn-fill btn-social btn-round step5" title="">
                <i class="fa fa-check"></i>
            </button>
        </li>
    </ol>  -->
