<?php
class IpcrReviewsCollection extends Helper {
    ...
    public function get_ipcr($postdata){
        $this->db->select('
            CONCAT(
        ...
        $this->db->join('tblipcrform b','a.id = b.name');
    ...
    public function get_ipcr_applicants(){
        $this->db->select('name');
    ...
    public function view_ipcr($postdata){
        ...
        //     $value->date_approve = date('M-d-Y',strtotime($value->date_approve));
        //     $value->date_assesed = date('M-d-Y',strtotime($value->date_assesed));
        //     $value->date_discussed = date('M-d-Y',strtotime($value->date_discussed));
        //     $value->date_final_rating = date('M-d-Y',strtotime($value->date_final_rating));
        //     $value->date_review = date('M-d-Y',strtotime($value->date_review));
        //     $value->posted_date = date('M-d-Y',strtotime($value->posted_date));
        // }
    ...
    public function update($postdata){
        ...
        $this->db->update('tblipcrform', $data);
        if($this->db->trans_status() === false){
            ...
            foreach ($form as $key => $value) {
               ...
               $this->db->update('tblipcranswer', $value);
               if($this->db->trans_status() === false)
                    $this->db->trans_rollback();
               else
                    $this->db->trans_commit();
