	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header bg-blue">
				<h2>
					Attendance Record Summary Report
					<small>Print Attendance Record Summary</small>
				</h2>
			</div>
			<div class="body">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/timekeepingreports/attendancesummary.js"></script>
