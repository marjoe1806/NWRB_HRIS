...
class EmployeeDTRSummary extends MX_Controller {
	...
	public function index() {
		Helper::rolehook(ModuleRels::SELF_EMPLOYEE_DTR);
		$listData = array();
		$viewData = array();
		...
		if (!$this->input->is_ajax_request()) {
			Helper::setTitle('My Daily Time Record');
			Helper::setMenu('templates/menu_template');
			Helper::setView('employeedtrsummary',$viewData,FALSE);
