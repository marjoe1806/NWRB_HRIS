		...
		<div style="text-align:center;margin-top:-3em;font-family:Arial;">
            ...
            <tr>
              ...
              <tr>
                ...
                <table id = "serviceOfrecord" classs="table table-bordered" style="width:100%; border: 1px dotted black;">
                ...
                <tr>
                    ...
                    <tr id = "SubHead">
                        ...
                        <td><button type="button" id="add_fields" data-num="0" style="float: right; margin: 10px 5px;" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="add">
            ...
            <?php if(sizeof($Data['Experience']) <= 0){?>
				<tr>
					<td colspan="11" style="text-align:center;">No Available Data</td>
				</tr>
				<?php }else{ ?>
            <?php foreach($Data["Experience"] as $key => $value): ?>
					...
					<td style="min-width: 50px">
                        <div class="form-button">
                            <div class="form-line">
                                <button type="button" id="deleteRecord" data-id="<?php echo $value['id'];?>"  data-emp="<?php echo $Data["employee"]["employee_id"];?>" data-url="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/deleteServiceRecord'; ?>" data-url2="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/editServiceRecordForm'; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="remove">
                    ...
                    <td style="min-width: 120px" class="aligncenter">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <?php if(is_numeric($value["monthly_salary"])):?>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <button type="submit" id="update" name="btnSubmit" style="float: right; margin: 10px 5px;" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Save" <?php if(sizeof($Data['Experience']) <= 0){ echo "disabled"; }?>>
