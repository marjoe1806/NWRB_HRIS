						...
						<tr>
							<td>
								<input type="checkbox" class="checkbox_table required" id="checkbox<?php echo $k; ?>" value="<?php echo @$v['id']; ?>"
								 name="checkbox" data-id="<?php echo @$v['id']?>" data-employee-number="<?php echo @$v['employee_number']?>" data-shift-id="<?php echo @$v['shift_id']?>" data-regular-shift="<?php echo @$v['regular_shift']?>">
