...
<div class="table-responsive listTable">
	<table id="datatables_shifting" class="table table-hover table-striped" style="width:100%;">
		<thead>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo $value->break_time_start; ?>
				</td>
				<td>
					<?php echo $value->break_time_end; ?>
				</td>
				<td>
					<?php echo $value->end_time; ?>
				</td>
				<td>
					<?php echo $value->working_hours; ?>
				</td>
				<td>
