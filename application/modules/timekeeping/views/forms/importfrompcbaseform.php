...
<div class="row clearfix">
	<div class="col-md-10 col-md-offset-1">
		<h4 class="text-info text-center">Import Raw PC Base Records</h4>
		<form action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" class="dropzone"
		 id="my-dropzone"></form>
		<center><label class="text-primary">Please select the (3) required files. Only accepts .mdb files</label></center>
	</div>
</div>
<div class="row clearfix">
	<div class="col-md-10 col-md-offset-1">
