...
class ImportMonthlyRunningBalance extends MX_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Helper');
		$this->load->model('ImportMonthlyRunningBalanceCollection');
	...
	public function index() {
		if (!$this->input->is_ajax_request()) {
			Helper::setTitle('Import Monthly Payroll Running Balance');
	...
	public function importexcel(){
		...
		$ret =  new ImportMonthlyRunningBalanceCollection();
