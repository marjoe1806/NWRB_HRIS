...
class EmployeeSchedules extends MX_Controller {
	
	public function __construct() {
		parent::__construct();
		$this->load->model('Helper');
		$this->load->model('EmployeeSchedulesCollection');
	...
	public function index() {
		...
		$listData['key'] = $page;
		$ret = new EmployeeSchedulesCollection();
		...
		$listData['list'] = $respo;
		$viewData['table'] = $this->load->view("helpers/employeescheduleslist",$listData,TRUE);

		if (!$this->input->is_ajax_request()) {
			Helper::setTitle('Employee Schedules');
			Helper::setMenu('templates/menu_template');
			Helper::setView('employeeschedules',$viewData,FALSE);
	...
	public function addEmployeeSchedulesForm(){
		...
		else
		{
			...
			$result['form'] = $this->load->view('forms/employeeschedulesform.php', $formData, TRUE);
		}
		echo json_encode($result);
	}
