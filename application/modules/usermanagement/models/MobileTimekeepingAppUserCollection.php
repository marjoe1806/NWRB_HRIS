<?php
	class MobileTimekeepingAppUserCollection extends Helper {
		...
		var $table = "tblmobileusers";   
      	var $order_column = array(
      				...
      				"DECRYPTER(tblemployees.middle_name,'sunev8clt1234567890',tblemployees.id)",
      				"DECRYPTER(tblemployees.extension,'sunev8clt1234567890',tblemployees.id)",
