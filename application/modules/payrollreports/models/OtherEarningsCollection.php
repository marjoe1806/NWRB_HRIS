<?php
	class OtherEarningsCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsotherearningsamortization";   
      	var $order_column = array('tblemployees.employee_number','tblemployees.first_name','tblfielddepartments.department_name','tbltransactionsotherearningsamortization.amount','tbltransactionsotherearningsamortization.balance');
		...
		function make_query($pay_basis,$payroll_period_id){
		    ...
		    $this->db->select(
		    	'tblemployees.*,
		    	tbltransactionsotherearnings.*,'.
		    	$this->table.'.*,
		    	tblfieldotherearnings.earning_code AS earning_code,
		    ...
		    $this->db->join("tbltransactionsotherearnings",$this->table.".other_earning_entry_id = tbltransactionsotherearnings.id","left");
		    $this->db->join("tblemployees","tbltransactionsotherearnings.employee_id = tblemployees.id","left");
		    $this->db->join("tblfieldotherearnings","tbltransactionsotherearnings.earning_id = tblfieldotherearnings.id","left");
		    $this->db->join("tblfieldperiodsettings","tbltransactionsotherearnings.payroll_period_id = tblfieldperiodsettings.id","left");
		...
		function fetchOtherEarnings($pay_basis,$payroll_period_id){
			$this->make_query($pay_basis,$payroll_period_id); 
		    $query = $this->db->get();
