<?php
	class LoanApplicationsCollection extends Helper {
		...
		var $table = "tbltransactionsloans";   
      	var $order_column = array('tblemployees.employee_number','tblemployees.first_name','tblfieldloans.code','tblfieldloanssub.code','date_started','loan_amount','maturity_date','amortization_per_month');
		...
		function fetchLoanApplications($pay_basis,$payroll_period_id){
			$this->make_query($pay_basis,$payroll_period_id);
		    $query = $this->db->get();
