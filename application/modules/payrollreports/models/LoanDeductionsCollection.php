<?php
	class LoanDeductionsCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsloansamortization";   
      	var $order_column = array('tblemployees.employee_number','tblemployees.first_name','tblfieldloans.code','tblfieldloanssub.code','tbltransactionsloansamortization.amount');
		...
		function make_query($pay_basis,$payroll_period_id){
		    ...
		    $this->db->join("tbltransactionsloans",$this->table.".loan_entry_id = tbltransactionsloans.id","left");
		...
		function fetchLoanDeductions($pay_basis,$payroll_period_id){
			$this->make_query($pay_basis,$payroll_period_id);
		    $query = $this->db->get();
