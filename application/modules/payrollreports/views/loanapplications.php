    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Loan Applications <small>Loans Summary</small>
                </h2>
            ...
            <div class="body">
                <div style="width:100%;padding-bottom:20px;" class="search_entry">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a id="computePayroll" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/' ?>" data-toggle="tooltip" data-placement="top" title="Search Loan Applications">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/payrollreports/loanapplications.js"></script>