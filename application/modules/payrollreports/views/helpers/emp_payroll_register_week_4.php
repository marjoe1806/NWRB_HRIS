                ...
                <div class="header-container" style="width:100%;">
                    ...
                    <table style="width:100%;border-bottom:0px;" id="hdTable">
                        <thead>
                            ...
                            <tr>
                                <td align="center" style="text-decoration: underline;"><b><?php echo "&emsp;".date('F 23, Y',strtotime(@$payroll_period[0]['start_date'])); ?></b> &emsp; to &emsp; <b><?php echo date('F 31, Y',strtotime(@$payroll_period[0]['end_date'])); ?></b>&emsp;</td>
                            </tr>
                            <tr>
                        ...
                        <table style="width:100%;" id="tmpTable">
                            <thead>
                                <tr>
                                    ...
                                    <th valign="middle" style="text-align:center; min-width: 50px;letter-spacing: 8px;" colspan="5">DEDUCTION</th>
                            ...
                            ?>
                            <tbody>
                                <tr><td colspan="18" align="center"><span id="division_label" style="font-weight: bolder;font-style: italic;"></span></td></tr>
                            ...
                            <?php foreach ($payroll as $k => $v) { 
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50px;"><!-- compensation --></td>
                                    <td style="width: 50px;"><!-- compensation --></td>
                                    <td valign="top" align="right"><?php $gross_pay = $v['cut_off_4']; echo number_format($gross_pay,2); $page_total["gross_pay"] += $gross_pay; $grand_total["gross_pay"] += $gross_pay; ?></td>
                                    ...
                                    <td valign="top" align="right"><?php //echo number_format($v['pera_wop_amt'],2); $page_total["pera_wop_amt"] += $v['pera_wop_amt']; $grand_total["pera_wop_amt"] += $v['pera_wop_amt']; ?></td>
                                    <td style="width: 50px;"></td>
                                    <td style="width: 50px;"></td>
                                    <td valign="top" align="right"><?php echo 0.00;//number_format($v['total_tardiness_amt'],2); $page_total["total_deduct_amt"] += $v['total_tardiness_amt']; $grand_total["total_deduct_amt"] += $v['total_tardiness_amt']; ?></td>
                                    <td valign="top" align="right"><?php $net_amnt_due = $v['cutoff_4']; echo number_format($net_amnt_due,2); $page_total["net_amnt_due"] += $net_amnt_due; $grand_total["net_amnt_due"] += $net_amnt_due; ?></td>
