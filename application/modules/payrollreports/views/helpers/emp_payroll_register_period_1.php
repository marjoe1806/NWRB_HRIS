...
<div class="row" style="overflow-x:auto;">
    <div class="col-md-12">
                        ...
                        <table style="width:100%;" id="tmpTable">
                            ...
                            <?php
                                $page_total = array(
                                    ...
                                    'pera_amt'=>0.00, 'gross_pera_amt'=>0.00 , 'mp2'=>0.00, 'lbp2'=>0.00, 'nwrbea_project'=>0.00, 'nwrbea_cashLoan'=>0.00, 'nwrbea_emergency'=>0.00, 'membership'=>0.00, 'kamanggagawa'=>0.00, 'project' => 0.00, 'cash_loan' => 0.00, 'emergency' => 0,.00 , 'union_dues' => 0.00, 'total_membership' => 0.00
                                );
                                $grand_total = array(
                                    ...
                                    'first_cut_off'=>0.00,'second_cut_off'=>0.00, 'membership'=>0.00, 'kamanggagawa'=>0.00 ,'project' => 0.00, 'cash_loan' => 0.00, 'emergency' => 0,.00 , 'union_dues' => 0.00
                                );
                                ...
                                $grand_total4 = array(
                                    'conso_loan'=>0.00, 'gfal'=>0.00, 'mpl'=>0.00, 'emergency_loan'=>0.00, 'cpl'=>0.00, 'policy_loan'=>0.00, 'opt_loan'=>0.00, 'opt_insurance'=>0.00, 'edu_assistance'=>0.00, 'membership'=>0.00, 'kamanggagawa'=>0.00, 'project'=>0.00, 'cash_loan'=>0.00
                                    , 'emergency'=>0.00, 'gsis'=>0.00, 'nhmfc'=>0.00, 'pagibig'=>0.00, 'total_membership' => 0.00
                                );
                                $grand_total5 = array(
                            ...
                            { 
                                ...
                                <tr>
                                    ...
                                    <?php   
                                        ...
                                        // Get the whole part of $compe1
                                        $wholeCompe1 = floor($compe1);
                                        // Get the decimal part of $compe1
                                        $decimalCompe1 = $compe1 - $wholeCompe1;
                                        // Round off the decimal part to 1 decimal place
                                        $roundedDecimalCompe1 = round($decimalCompe1, 1);
                                        // Combine the whole part and the rounded decimal part
                                        $roundedCompe1 = $wholeCompe1 + $roundedDecimalCompe1;

                                        //$second_value = $payroll[$v]['basic_pay'] - $compe1;
                                    ?>
                                    <input type="hidden" name="cut_off_1st" id="<?php echo $payroll[$v]["id"]."_cut_off_1st";?>" value="<?php echo $wholeCompe1; ?>">
                                    <td valign="middle" align="right" data-value="<?php echo $compe1; ?>" id="<?php echo $payroll[$v]["id"]."_cut_off1"; ?>">
                                        <?php
      ...
      <!-- Pera Allowance 1st Cut --><td valign="middle" align="right" id="<?php echo $payroll[$v]["id"]."_pera_amt"; ?>">
                                            <?php
                                        // Check if absence data exists and calculate $absent
                                        $absent = 0;

                                        // Check if the necessary keys exist before accessing
                                        if (
                                            isset($ut[$payroll[$v]['employee_id']]) &&
                                            is_array($ut[$payroll[$v]['employee_id']]) &&
                                            isset($ut[$payroll[$v]['employee_id']]['absent'])
                                        ) {
                                            $absent = $ut[$payroll[$v]['employee_id']]['absent'];

                                            // Check if $absent is not null and not equal to 0
                                            if ($absent !== null && $absent !== 0) {
                                                // Calculate Pera Allowance 1st Cut based on absence and other conditions
                                                $pera_1st_cut = 0;

                                                // Check if $absent is not 0
                                                if ($absent != 0) {
                                                    $pera = $payroll[$v]['pera_amt'] / 22;
                                                    $pera_wop = $absent * $pera;
                                                    $p = $payroll[$v]['pera_amt'] - $pera_wop;
                                                    $pera_1st_cut = floor($p / 2);
                                                    $pera_2nd_cut =  $p - $pera_1st_cut;
                                                } else {
                                                    $pera_1st_cut = floor($payroll[$v]['pera_amt'] / 2);
                                                    $pera_2nd_cut = $payroll[$v]['pera_amt'] - $pera_1st_cut;
                                                }
                                           
                                                // Display the result
                                                echo number_format($pera_1st_cut, 2);
                                            } else {
                                                echo "Absent value is null or 0 for employee with ID: " . $payroll[$v]['employee_id'];
                                            }
                                        } else {
                                            echo "Absent data not available for employee with ID: " . $payroll[$v]['employee_id'];
                                        }
                                        ?>
                                    ...
                                    <?php $gross_pay = $wholeCompe1 + $pera_1st_cut ; echo number_format($gross_pay,2); $page_total["gross_pay"] += $gross_pay; $grand_total["gross_pay"] += $gross_pay; ?>
                                ...
                                <tr>
                                    ...
                                    <td></td>
									<td></td>
									<td align="right"  data-value="<?php echo ($payroll[$v]['basic_pay'] - $wholeCompe1); ?>" id="<?php echo $payroll[$v]["id"]."_cut_off2"; ?>">
                                    <?php 
                                        if($compe1 < 0 ){
                                            $compe1Value = abs($wholeCompe1);
                                        }else{
                                            $compe1Value = $wholeCompe1;
                                        }

                                        $second_value = $payroll[$v]['basic_pay'] - $compe1Value;

                                       // Extract the last 3 decimal places
                                    //    $decimal_part = $second_value - floor($second_value);
                                    //    // Round off the extracted decimal part to 1 decimal place
                                    //    $rounded_decimal_part = round($decimal_part, 1);
                                    //    $round = $roundedDecimalCompe1 +  $rounded_decimal_part;
                                       // Combine the whole part of the number and the rounded decimal part
                                    //    $rounded_value = floor($second_value) + $round;
                                       echo number_format($second_value, 2);
                                       $cut_off_2nd = $second_value; // Use the rounded value for further calculations
                                       // var_dump($cut_off_2nd);
                                        
                                        //echo number_format($rounded_value, 2); // Format the output if needed
									...
									<td align="right">
                                        <?php                                                                             
                                            $pera_amt = $pera_2nd_cut; echo number_format($pera_2nd_cut,2); 
                                        ?>
                                    </td>
    ...
    <!--11th column TAX--><td valign="middle" align="right">
                            <?php 
                                $cut_wh_tax_amt = 0; 
                                
                                // Check if $tax and the necessary keys exist before accessing
                                if (
                                    isset($tax[$payroll[$v]['employee_id']]) &&
                                    is_array($tax[$payroll[$v]['employee_id']]) &&
                                    isset($tax[$payroll[$v]['employee_id']][0]) &&
                                    is_array($tax[$payroll[$v]['employee_id']][0]) &&
                                    array_key_exists('wh_tax_amt', $tax[$payroll[$v]['employee_id']][0])
                                ) {
                                    $tax_amt = $tax[$payroll[$v]['employee_id']][0]['wh_tax_amt'];
                                    
                                    // Check if $tax_amt is not null and not equal to 0
                                    if ($tax_amt !== null && $tax_amt !== 0) {
                                        $cut_wh_tax_amt = $tax_amt;
                                    }
                                }
                                
                                echo number_format($cut_wh_tax_amt, 2); 
                                $rowtotaldeduction += $cut_wh_tax_amt; 
                                $page_total["wh_tax_amt"] += $cut_wh_tax_amt; 
                                $grand_total["wh_tax_amt"] += $cut_wh_tax_amt;
                            ?>
                        </td>
...
<!-- 16th column LBP livelihood--><td valign="middle" align="right"><?php $val = 0; $val = get_key(39,$loanDeductions[$payroll[$v]['employee_id']]); echo number_format($val ,2); $rowtotaldeduction += $val; $page_total["lbp2"] += $val; $grand_total2["lbp2"] += $val; ?></td>
                                    <?php
                                        ...
                                        $mem = $membership +  $union_dues; $page_total["total_membership"] += $mem; $grand_total4["total_membership"] += $mem;
                                    ...
                                    <?php
                                            // if($count1 + 1 <= sizeof($payroll_2[$payroll[$v]['employee_id']])){
                                                ...
                                                if ($totalAbs_late < 0) {
                                                  ...
                                                  $totalAbs_late;
                                                  //echo number_format($totalAbs_late, 2);
                                                }
...
<!--18th column Lates & absenses--><td valign="middle" align="right"><?php echo number_format($totalAbs_late, 2); $grand_total["late_amt"] += $totalAbs_late; ?></td>
								<td valign="middle" align="right"  id="<?php echo $payroll[$v]["id"]."_total_deduct"; ?>">
                                        ...
                                        $page_total["total_deductions"] += $payroll[$v]['total_deduct_amt']; $grand_total["total_deductions"] += $total_deduct; 
                          ...
                          $val17 = get_key(20,$loanDeductions[$payroll[$v]['employee_id']]);$grand_total4['pagibig'] += $val17;		
                                ...
                                array_push($total_Membership, $grand_total4["total_membership"]);	
                        ...
                        <table style="width:100%; border-bottom:0px;" id="tblGSIS">
                            ...
                            <tr>
                                ...
                                <?php
                                        ...
                                        $nwrbea = $membership + $kamanggagawa + $project + $cash_loan + $emergency + $union_dues;
                                        //var_dump("membership: " . $membership . ", kamanggagawa: " . $kamanggagawa . ", project: " . $project . ", cash_loan: " . $cash_loan . ", emergency: " . $emergency . ", union_dues: " . $union_dues);
                                ?>      
                                <td><?php $val10 = 0; $val10 = $membership + $union_dues; echo number_format($val10,2); $rowtotaldeduction += $val; $page_total["membership"] += $membership; $grand_total['membership'] += $val10;  ?></td> 
                                <td><?php $val11 = 0; $val11 = $kamanggagawa; echo number_format($val11,2); $rowtotaldeduction += $val; $page_total["kamanggagawa"] += $kamanggagawa; $grand_total['kamanggagawa'] += $val11;  ?></td> 
                                <td><?php $val12 = 0; $val12 = $project; echo number_format($val12,2); $rowtotaldeduction += $val; $page_total["project"] += $project; $grand_total['project'] += $val12;  ?></td> 
                                <td><?php $val13 = 0; $val13 = $cash_loan; echo number_format($val13,2); $rowtotaldeduction += $val; $page_total["cash_loan"] += $cash_loan; $grand_total['cash_loan'] += $val13;  ?></td> 
                                <td><?php $val14 = 0; $val14 = $emergency; echo number_format($val14,2); $rowtotaldeduction += $val; $page_total["emergency"] += $emergency; $grand_total['emergency'] += $val14;  ?></td> 
                            ...
                            <?php
                             ...
                             $total_total_deduct = 0;
                                 for($v = 0 ; $v < sizeof($payroll); $v++ ){ 
                                    ...
                                    $employee_id = $payroll[$v]['employee_id'];

                                    if (isset($tax[$employee_id]) && is_array($tax[$employee_id]) && isset($tax[$employee_id][0]['wh_tax_amt'])) {
                                        $tax_amt = $tax[$employee_id][0]['wh_tax_amt'];
                        ...
                        <table style="width:100%; border-bottom:0px;" id="tblGSIS">
                            ...
                            <?php
                             ...
                             foreach ($payroll as $k => $v) { //Loop for table below
                            //var_dump($v['union_dues_amt']);
                            ?>
                            ...
                            <tr>
                                ...
                                <td valign="middle" align="right"><?php $val = 0; $val = get_key(40, $loanDeductions[$v['employee_id']]) +  $v['union_dues_amt']; echo number_format($val, 2); $membership_total += $val;?> </td>
                            ...
                            <tr>
                                ...
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['opt_insurance'] , 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['edu_assistance'] , 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['membership'] += $membership_total, 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['kamanggagawa'] , 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['project'] , 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['cash_loan'] , 2);?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total3['emergency'] , 2);?></td>
                            ...
                            <td>&nbsp;</td>
                                ...
                                <td style="text-align:center;font-weight: bold;"><?php echo number_format($grand_total4['membership'] += $membership_total, 2); ?></td>
