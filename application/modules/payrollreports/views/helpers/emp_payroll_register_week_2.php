                ...
                <div class="header-container" style="width:100%;">
                    ...
                    <table style="width:100%;border-bottom:0px;" id="hdTable">
                        <thead>
                            ...
                            <tr>
                                <td align="center" style="text-decoration: underline;"><b><?php echo "&emsp;".date('F 8, Y',strtotime(@$payroll_period[0]['start_date'])); ?></b> &emsp; to &emsp; <b><?php echo date('F 15, Y',strtotime(@$payroll_period[0]['end_date'])); ?></b>&emsp;</td>
                            </tr>
                            <tr>
                        ...
                        <table style="width:100%;" id="tmpTable">
                            ...
                            <?php foreach ($payroll as $k => $v) { 
                                ...
                                <tr>
                                    ...
                                    <td style="min-width: 50px;"><!-- compensation --></td>
                                    <td valign="top" align="right"><?php $gross_pay = $v['cut_off_2']; echo number_format($gross_pay,2); $page_total["gross_pay"] += $gross_pay; $grand_total["gross_pay"] += $gross_pay; ?></td>
                                    ...
                                    <td style="min-width: 50px;"></td>
                                    <td style="min-width: 50px;"></td>
                                    <td valign="top" align="right"><?php $net_amnt_due = $v['cutoff_2']; echo number_format($net_amnt_due,2); $page_total["net_amnt_due"] += $net_amnt_due; $grand_total["net_amnt_due"] += $net_amnt_due; ?></td>
