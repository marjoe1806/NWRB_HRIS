                        ...
                        ?>
                            ...
                            <tbody class="page-break">
                                ...
                                <tr style="text-align:center;border-top: 1px solid black;">
                                    ...
                                    <td style="text-align:left" nowrap valign="middle">Name of Employee
                                    </td>
                                    <td nowrap valign="middle">
                                        <?php 
                                            if($pay_basis == "Permanent")
                                                echo 'Monthly<br>Rate';
                                            elseif ($pay_basis == "Casual")
                                                echo 'Daily<br>Rate'
                                        ?>
                                        
                                    </td>
                                    <td nowrap valign="middle">Under<br>Payment</td>
                                ...
                                <tr style="text-align:center">
                                    ...
                                    <td rowspan="2" nowrap valign="middle">Over<br>Payment</td>
                                    ...
                                    <td rowspan="2" nowrap valign="middle">UNION<br>DUES</td>
                                ...
                                foreach ($payroll as $k => $v) {?>
                                    ...
                                    <tr style="">
                                        ...
                                        <td nowrap="" style="text-align:left;" valign="top">
                                            ...
                                            <?php 
                                                ...
                                                echo str_replace(' ', '', $middle_name) != "" ? '&emsp;'.$middle_name : ""; ?>
                                            </b>
                                        </td>
                                        ...
                                        <td nowrap style="text-align:right;" valign="top">
                                            <?php 
                                            $loan = "0.00";
                                            if(sizeof($otherEarnings[$v['employee_id']]) > 0){
                                                foreach ($otherEarnings[$v['employee_id']] as $l1 => $vl1) {
                                                    if($vl1['earning_code'] == "Underpayment"){
                                            ...
                                            echo $loan;
                                            ?>
                                            <?php $grand_total['underpayment'] += (double) str_replace( ',', '', $loan ); ?>
                                            <?php $page_total['underpayment'] += (double) str_replace( ',', '', $loan ); ?>
                                        </td>
                                        <td nowrap style="text-align:right;" valign="top">
                                        ...
                                        <td nowrap style="text-align:right;" valign="top">
                                            ...
                                            if(sizeof($loanDeductions[$v['employee_id']]) > 0){
                                                foreach ($loanDeductions[$v['employee_id']] as $l1 => $vl1) {
                                                    if($vl1['code_loan'] == "Other Loans" && $vl1['code_sub'] == "Dagliang"){
                                                        $loan = number_format($vl1['amount'],2);
                                                        break;
                                                    }
                                                    else
                                        ...
                                        <td nowrap style="text-align:right;" valign="top">
                                            ...
                                            if(sizeof($otherDeductions[$v['employee_id']]) > 0){
                                                foreach ($otherDeductions[$v['employee_id']] as $l1 => $vl1) {
                                                    if($vl1['deduct_code'] == "Overpayment"){
                                                        $loan = number_format($vl1['amount'],2);
                                                        break;
                                                    }
                                                    else
                                            ...
                                            echo $loan;
                                            ?>
                                            <?php $grand_total['overpayment'] += (double) str_replace( ',', '', $loan ); ?>
                                            <?php $page_total['overpayment'] += (double) str_replace( ',', '', $loan ); ?>
                                        </td>
                                        <td nowrap style="text-align:right;" valign="top">
                                    ...
                                    if((($k+1)/$total_per_page) === (intval(($k+1)/$total_per_page)) || sizeof($payroll) == 0){ ?>
                                        <tr style="font-weight:bold;border-top:1px solid black;text-align:right;" class="page_total">
                                            ...
                                            <td valign="top">
                                                <?php echo number_format((double)@$page_total['underpayment'],2); ?>
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr style="font-weight:bold;text-align:right;" class="page_total">
                                            ...
                                            <td valign="top"></td>
                                            <td valign="top">
                                                <?php echo number_format((double)@$page_total['overpayment'],2); ?>
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <?php echo number_format((double)@$page_total['union_dues_amt'],2); ?>
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr style="font-weight:bold;text-align:right;" class="page_total">
                                            ...
                                            <td valign="top"></td>
                                            <!-- <td valign="top">
                                                <?php echo '####'.number_format((double)@$page_total['damayan_amt'],2); ?>
                                            </td> -->
                                            <td valign="top">
                                        ...
                                        <tr style="font-weight:bold;text-align:right;" class="grand_total">
                                            ...
                                            <td valign="top">
                                                <?php echo number_format((double)@$grand_total['underpayment'],2); ?>
                                            </td>
                                            <td valign="top">
                                        ...
                                        <tr style="font-weight:bold;text-align:right;" class="grand_total">
                                            ...
                                            <td valign="top"></td>
                                            <td valign="top">
                                                <?php echo number_format((double)@$grand_total['overpayment'],2); ?>
                                            </td>
                                            <td valign="top">
                                            ...
                                            <td valign="top">
                                                <?php echo number_format((double)@$grand_total['union_dues_amt'],2); ?>
                                            </td>
                                            <td valign="top">
