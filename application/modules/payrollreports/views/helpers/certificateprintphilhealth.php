        ...
        <div style="width:100%; overflow-x:auto;">
            <div id="clearance-div">
                ...
                <div id="certificate-container">
                    ...
                    <?php
                        if($list[0]['sub_loans_id'] == 0) {
                        // var_dump($list[0]['first_name'].' '.$list[0]['middle_name'].' '.$list[0]['last_name']);die();
                    ?>                    
                    <p>This is to certify that the following amount  was  remitted  to <b>Philippine  Health  Insurance Corporation  (PHIC)</b>   
                    by the <b>NATIONAL WATER RESOURCES BOARD</b> 
                    with <b>Employer ID No. 140374100047</b> for the account of <b>Mr/Ms. <?php echo $list[0]['first_name'].' '.$list[0]['middle_name'].' '.$list[0]['last_name']; ?> </b>
                    as follows:
                    </p>
                    <table id="mainTable">
                        <thead style="text-align:center; font-weight: bold;">
                            ...
                            <td style=" border: solid 1px #3b3b3b;">PS</td>
                            <td style=" border: solid 1px #3b3b3b;">ES</td>
                        ...
                        <?php 
                            ...
                            if(isset($list) && sizeof($list) > 0):
                                foreach($list as $k => $v) {
                                    // $total_emp_share += $v['employee_share'];
                                    // $total_empr_share += $v['employeer_share'];
                                    // $total_amount += $v['total_amount'];
                                    $total_emp_share += $v['philhealth_amt'];
                                    $total_empr_share += $v['philhealth_amt_employer'];
                                    $sum_amount = $v['philhealth_amt'] + $v['philhealth_amt_employer'];
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center; border: solid 1px #3b3b3b;"><?php 
                                //echo number_format($v['employee_share'],2); 
                                echo number_format($v['philhealth_amt'],2);?></td>
                                <td style="text-align:center; border: solid 1px #3b3b3b;"><?php 
                                //echo number_format($v['employeer_share'],2); 
                                echo number_format($v['philhealth_amt_employer'],2)?></td>
                                <td style="text-align:center; border: solid 1px #3b3b3b;"><?php echo number_format($sum_amount,2); ?></td>
                            </tr>
                        <?php
                                } 
                            endif; 
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; border: solid 1px #3b3b3b; font-weight: bold;"><?php echo number_format($total_emp_share,2); ?></td>
                            <td style="text-align:center; border: solid 1px #3b3b3b; font-weight: bold;"><?php echo number_format($total_empr_share,2); ?></td>
