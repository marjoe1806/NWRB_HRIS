                        ...
                        <table style="width:100%;" id="tmpTable">
                            ...
                            <?php
                                $page_total = array(
                                    ...
                                    'pera_amt'=>0.00, 'gross_pera_amt'=>0.00 , 'mp2'=>0.00, 'lbp2'=>0.00, 'nwrbea_project'=>0.00, 'nwrbea_cashLoan'=>0.00, 'nwrbea_emergency'=>0.00, 'membership'=>0.00, 'kamanggagawa'=>0.00, 'project' => 0.00, 'cash_loan' => 0.00, 'emergency' => 0,.00 , 'union_dues' => 0.00,
                                    'total_membership'=> 0.00
                                );
                                $grand_total = array(
                            ...
                            { 
                                ...
                                <tr>
                                    ...
                                    <?php 
                                       ...
                                       echo number_format($rounded_value, 2);
                                       $cut_off_2nd = $rounded_value; // Use the rounded value for further calculations
                        ...
                        <table style="width:100%; border-bottom:0px;" id="tblGSIS">
                            ...
                            <td>&nbsp;</td>
                             ...
                             ?>
                                ...
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($grand_total4['membership'] , 2);?></td>
                        ...
                        <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($total_Membership[$x], 2); ?> TEST</td>
                                ...
                                ?>
                                   ...
                                   <tr>
                                    ...
                                    <td style="text-align:center;font-weight: bold;"><?php echo number_format($second_Membership1, 2); ?></td>
...
$mem = $membership +  $union_dues; $page_total["membership"] += $mem; $grand_total4["membership"] += $mem;