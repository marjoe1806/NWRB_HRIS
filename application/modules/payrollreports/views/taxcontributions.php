		...
		<div class="card">
			<div class="header bg-blue">
				<h2>
					...
					<small>Print Tax Contributions Report</small>
				</h2>
			</div>
			<div class="body">
				<div style="width:100%; padding-bottom: 20px" class="search_entry">
					...
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<a id="summarizeAllTaxContributions" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/summarizeAllTaxContributions' ?>">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/payrollreports/taxcontributions.js"></script>
