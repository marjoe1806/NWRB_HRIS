    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Pagibig Housing Loan / LCHL Remittance Report
                </h2>
            ...
            <div class="body">
                <div style="width:100%;padding-bottom:20px;" class="search_entry">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a id="viewPagibigLCHLSummary" href="'+commons.baseurl+'remittance/PagibigLCHL/viewPagibigLCHLSummary">
                                <button type="button" class="btn btn-block btn-lg btn-info waves-effect">
                                <i class="material-icons">print</i> Generate Report
                                </button>
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/remittance/pagibig_lchl.js"></script>