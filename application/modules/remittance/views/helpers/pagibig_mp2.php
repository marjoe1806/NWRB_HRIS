        ...
        <div style="width:100%;">
            <div id="clearance-div">
                ...
                <?php
                    ...
                    $rows = 0;
                    $grand_total = array(
                        'mp2_contribution_amt'=>0.00, 'pagibig_amt_employer'=>0.00
                    );
                ?>
                <div class="header-container" style="width:100%;">
                    ...
                    <div class="table-container"><?php $page++; ?>
                        <table class="table table-hover table-striped" style="width:100%;" id="tmpTable">
                            <thead>
                                <tr>
                                    <th style="text-align:center;">Pag-IBIG MID NO.</th>
                                    <th style="text-align:center;">MP2 ACCT. NO.</th>
                                    <th style="text-align:center;">MEMBERSHIP <br>PROGRAM</th>
                                    <th style="text-align:center;">LAST NAME</th>
                                    <th style="text-align:center;">FIRST NAME</th>
                                    <th style="text-align:center;">NAME <br>EXT.</th>
                                    <th style="text-align:center;">MIDDLE NAME</th>
                                    <th style="text-align:center;">PERCOV</th>
                                    <th style="text-align:center;">EE SHARE</th>
                                    <th style="text-align:center;">ER SHARE</th>
                                    <th style="text-align:center;">Additional for the <br>month of(voucher)</th>
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" align="right"><?php echo number_format($payroll[$v]['mp2_contribution_amt'] , 2);$page_total["mp2_contribution_amt"] += $payroll[$v]['mp2_contribution_amt']; $grand_total["mp2_contribution_amt"] += $payroll[$v]['mp2_contribution_amt'];  ?></td> 
                                    <td valign="middle" align="right"><?php //echo number_format($payroll[$v]['pagibig_amt_employer'] , 2);$page_total["pagibig_amt_employer"] += $payroll[$v]['pagibig_amt_employer']; $grand_total["pagibig_amt_employer"] += $payroll[$v]['pagibig_amt_employer'];  ?></td> 
                            ...
                            <tr>
                                ...
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($page_total["mp2_contribution_amt"],2); ?></td>
                                <td valign="middle" align="right" style="font-weight: bold;"><?php //echo number_format($page_total["pagibig_amt_employer"],2); ?></td>
                            ...
                            <?php if($page == $total_page) { ?>
                                <tr style="border: none;">
                                    <td valign="middle" align="left" style="font-weight: bold; border: none;" colspan="8">TOTAL REMITTANCE</td>
                                    <td valign="middle" align="right" style="font-weight: bold; border-top:0;border-left:0;border-right:0;border-bottom:3px solid;border-style:double;"><?php echo number_format($grand_total["mp2_contribution_amt"],2); ?></td>
                                    <td valign="middle" align="right" style="font-weight: bold; border-top:0;border-left:0;border-right:0;border-bottom:3px solid;border-style:double;"><?php //echo number_format($grand_total["pagibig_amt_employer"],2); ?></td>
                ...
                <div class="header-container" style="width:100%; display:none;" id="excelTablediv">
                    <table class="excelTable no-print" style="width:100%;border-bottom:0px;border-top:5px" id="hdTable">
                        <thead>
                            <tr>
                                <td colspan="4"><b>Employer ID:&emsp; 202240010005</b></td>
                            </tr>
                            <tr>
                                <td colspan="4"><b>Employer Name:&emsp; NATIONAL WATER RESOURCES BOARD</b></td>
                            </tr>
                            <tr>
                                <td colspan="4"><b>Address:&emsp; 8TH FLR NIA BLDG EDSA QUEZON CITY</b></td>
                            </tr>
                        </thead>
                    </table>
                        ...
                        <table class="table table-hover table-striped excelTable no-print" style="width:100%;" id="excelTable">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">MEMBERSHIP PROGRAM</th>
                                    <th style="text-align:center;">LAST NAME</th>
                                    <th style="text-align:center;">FIRST NAME</th>
                                    ...
                                    <th style="text-align:center;">EE SHARE</th>
                                    <th style="text-align:center;">ER SHARE</th>
                                    <th style="text-align:center;">Additional for the month of(voucher)</th>
                                    <th style="text-align:center;">REMARKS</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
    function saveAsExcel() {
        ...
        $('.excelTable').tableExport({
            type: "excel",
            fileName: "Pag-ibig MP2 Remittance Report"
        });
        setTimeout(() => {
