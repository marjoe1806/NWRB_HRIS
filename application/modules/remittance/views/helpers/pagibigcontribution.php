        ...
        <div style="width:100%;">
            <div id="clearance-div">
                ...
                <?php
                    ...
                    $rows = 0;
                    $grand_total = array(
                        'pagibig_amt'=>0.00, 'pagibig_amt_employer'=>0.00
                    );
                ?>
                        ...
                        <table class="table table-hover table-striped" style="width:100%;" id="tmpTable">
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" align="right"><?php echo number_format($payroll[$v]['pagibig_amt'] , 2);$page_total["pagibig_amt"] += $payroll[$v]['pagibig_amt']; $grand_total["pagibig_amt"] += $payroll[$v]['pagibig_amt'];  ?></td> 
                            ...
                            <tr>
                                ...
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($page_total["pagibig_amt"],2); ?></td>
                            ...
                            <?php if($page == $total_page) { ?>
                                <tr style="border: none;">
                                    ...
                                    <td valign="middle" align="right" style="font-weight: bold; border-top:0;border-left:0;border-right:0;border-bottom:3px solid;border-style:double;"><?php echo number_format($grand_total["pagibig_amt"],2); ?></td>
...
<script>
    function saveAsExcel() {
        ...
        $('.excelTable').tableExport({
            type: "excel",
            fileName: "Pag-ibig Remittance Report - Regular"
        });
        setTimeout(() => {
