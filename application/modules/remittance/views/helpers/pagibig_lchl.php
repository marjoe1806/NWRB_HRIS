                        ...
                        <table class="table table-hover table-striped" style="width:100%;" id="tmpTable">
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="text-align:center;">LCHL</td>
                                    <td valign="middle" align="right"><?php $val = 0; $val = get_key(20,$loanDeductions[$payroll[$v]['employee_id']]); echo number_format($val,2); $page_total["lchl_amt"] += $val; $grand_total["lchl_amt"] += $val;?></td>
                            ...
                            <tr>
                                ...
                                <td valign="middle" align="right" style="font-weight: bold;"><?php echo number_format($page_total["lchl_amt"],2); ?></td>
                            ...
                            <?php if($page == $total_page) { ?>
                                <tr style="border: none;">
                                    <td valign="middle" align="left" style="font-weight: bold; border: none;" colspan="7">TOTAL LCHL AMORTIZATION</td>
                                    <td valign="middle" align="right" style="font-weight: bold; border-top:0;border-left:0;border-right:0;border-bottom:3px solid;border-style:double;"><?php echo number_format($grand_total["lchl_amt"],2); ?></td>
...
<script>
    function saveAsExcel() {
        ...
        $('.excelTable').tableExport({
            type: "excel",
            fileName: "Pag-ibig Housing Loan Remittance Report"
        });
        setTimeout(() => {
