        ...
        <div class="card">
            ...
            <div class="body">
                <div style="width:100%;padding-bottom:20px;" class="search_entry">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a id="viewPagibigMP2Summary" href="'+commons.baseurl+'remittance/PagibigMP2/viewPagibigMP2Summary">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/remittance/pagibig_mp2.js"></script>