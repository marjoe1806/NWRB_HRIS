<?php
	class ExhaustedPostingCollection extends Helper {
		...
		//Fetch
		var $table = "tblleaveexhaustedposting";   
		...
		public function addExhaustedPosting($params){
			//var_dump($params);die();
			//var_dump($params);die();
			$helperDao = new HelperDao();
			$code = "1";
			...
			foreach ($params['leave_year'] as $k => $v) {
				$balances[] = array(
					...
					"leave_month"  	=> $params['leave_month'][$k],
				...
				$this->db->query("DELETE FROM tblleaveexhaustedposting WHERE employee_id = '".$params['employee_id'][$k]."' AND leave_year = ".$params['leave_year'][$k]);
				//var_dump($participants);die();
				//$this->db->insert('tblleavemanagementdaysleave', $days);
			}
			$this->db->insert_batch('tblleaveexhaustedposting', $balances);
		...
		public function updateExhaustedPosting($params){
			//var_dump($params);die();
			//var_dump($params);die();
			$helperDao = new HelperDao();
			$code = "1";
