    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Leave Ledger Exhausted <small>Leave Ledger Exhausted Summary</small>
                </h2>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/leavemanagement/leaveledgerexhausted.js"></script>