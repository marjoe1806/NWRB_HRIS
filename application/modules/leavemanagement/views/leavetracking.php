    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Leave Status Tracking <small>Viewing of all leave status</small>
                </h2>
            </div>
            <div class="body">
                <div class="row">
...
<?php echo $form; ?>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/leavemanagement/leavetracking.js"></script>
