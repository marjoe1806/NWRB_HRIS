    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Compensatory Time Off Approval<small>Manage Compensatory Time Off Approval</small>
                </h2>
...
<?php echo $form; ?>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/leavemanagement/ctoapproval.js"></script>
