        ...
        <tbody>
            ...
            if(isset($list->Data->details) && sizeof($list->Data->details) > 0): 
                ...
                <tr>
                    ...
                    <td>
                        <a  id="viewApprovedLeaveDetails"
                            class="viewApprovedLeave<?php echo $value->leave_kind; ?>Details btn btn-info btn-circle waves-effect waves-circle waves-float"
                            href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/viewApprovedLeave'.$value->leave_kind.'Details'; ?>"  data-toggle="tooltip" data-placement="top" title="View Details"
