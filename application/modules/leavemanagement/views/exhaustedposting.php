        ...
        <div class="card">
            <div class="header bg-blue">
                <h2 style="font-size: 2.2rem">
                    <i class="fa fa-id-card-o" aria-hidden="true"></i>Exhausted Posting
                    <small>Employee Balance Brought Posting</small>
                </h2>
                <ul class="header-dropdown m-r-0">
                    <li>
                        <?php if(Helper::role(ModuleRels::EXHAUSTED_ADD_RECORDS)): ?>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/leavemanagement/exhaustedposting.js"></script>