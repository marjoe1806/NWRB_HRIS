<?php
    ...
    if($ledger['Code'] == "0"){
        ...
        $employee_civil_status = $ledger['Data']['details'][0]['employee_civil_status'];
        ...
        $leave_vacation_balance_brought = $ledger['Data']['details'][0]['leave_vacation_balance_brought'];
        $leave_sick_balance_brought = $ledger['Data']['details'][0]['leave_sick_balance_brought'];
    }
?>
<div class="row">
    <div class="col-md-12">
        <div id="clearance-div">
            ...
            <div id="certificate-container">
                ...
                <div class="body table-responsive">
                    <table class="table tablebordered table-bordered table-hover table-striped" style="text-transform: uppercase;text-align:center;width:100%;font-size:10px;" id="leaveapplicationtable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td></td>
                                <td>BAL. BROUGHT FORWARD</td>
                                <td></td>
                                <td></td>
                                <td class="text-primary"><?php echo $leave_vacation_balance_brought; ?></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td class="text-primary"><?php echo $leave_sick_balance_brought; ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <?php 
                            if($ledgermonthly['Code'] == "0"){
                                foreach ($ledgermonthly['Data']['details'] as $k => $value) {
                            ?>
                            <tr>
                                <td><?php echo $value['name']; ?></td>
                                <td></td>
                                <td class="text-success"> <?php echo '+'.$value['leave_vacation_earned']; ?></td>
                                <td class="text-danger"> <?php echo (($value['leave_vacation_undertime_w_pay'] != "0" || $value['leave_vacation_undertime_w_pay'] != "-0")?'-'.$value['leave_vacation_undertime_w_pay']:""); ?></td>
                                ...
                                <td class="text-danger"> <?php echo (($value['leave_sick_undertime_w_pay'] != "0" || $value['leave_sick_undertime_w_pay'] != "-0")?'-'.$value['leave_sick_undertime_w_pay']:""); ?></td>
