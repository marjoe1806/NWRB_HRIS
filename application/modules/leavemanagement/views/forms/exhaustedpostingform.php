...
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<center>
		    <h2 style="border-bottom: solid 1px;">Exhausted Posting</h2>
		</center>
		<div class="row">
			<!-- <div class="col-md-4">
			    ...
			    <table class="table table-bordered table-hover table-striped" style="text-transform: uppercase;text-align:center" id="leaveapplicationtable">
			        <thead>
			            <tr>
			                ...
			                <th rowspan="2" style="width:38%;">Employee</th>
							...
							<td>
			                	<div class="form-group">
            	                    <div class="form-line month_select">
            	                        <select data-container="body" class="leave_month form-control" name="leave_month[]" id="leave_month" data-live-search="true" required>
            	                        	<?php 
            	                        	$months = array(
            	                        		'01'=>'January',
            	                        		'02'=>'February',
								...
								<div class="form-group">
									<div class="form-line">
										<input type="number" name="vl_balance_amt[]" id="vl_balance_amt"
											class="vl_balance_amt form-control" step=".001" max="1.250">
									</div>
								</div>
							</td>
							<td>
								<div class="form-group">
									<div class="form-line">
										<input type="number" name="sl_balance_amt[]" id="sl_balance_amt"
											class="sl_balance_amt form-control" step=".001" max="1.250">
									</div>
								</div>
							</td>
							<td>
