    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Compensatory Time Off Ledger <small>Compensatory Time Off Summary</small>
                </h2>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/leavemanagement/ctoledger.js"></script>