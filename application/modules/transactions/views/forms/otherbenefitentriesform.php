<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
            ...
            <?php if($key == "addOtherBenefitEntries"): ?>
            <div class="col-md-6">
                <label class="form-label">Serivce / Unit / Division <span class="text-danger">*</span></label>
                <div class="form-group">
                    <div class="form-line">
                        <select class=" form-control " name="division_id" id="division_id" data-live-search="true" required>
                            <option value=""></option>
...
<!--         <div class="row clearfix">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="number" pattern="\d*" onKeyPress="if(this.value.length==4) return false;" min="0" name="year" id="year" maxlength="4" class="year form-control" required >
                    </div>
                </div>
            </div>
        </div> -->
		...
		<div class="row clearfix">
            <div class="col-md-12">
                <label class="form-label">Type of Benefit <span class="text-danger">*</span></label>
                <div class="form-group">
                    <div class="form-line benefit_select">
    ...
    <div class="text-right" style="width:100%;">
    	...
    	<?php endif; ?>
    	<?php if($key == "updateOtherBenefitEntries"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
