...
<!--         <div class="row clearfix">
		...
		<div class="row clearfix">
            <div class="col-md-12">
                <label class="form-label">Type of Earning <span class="text-danger">*</span></label>
                <div class="form-group">
                    <div class="form-line earning_select">
    ...
    <div class="text-right" style="width:100%;">
    	<?php if($key == "addOtherEarningEntries"): ?>
    	...
    	<?php endif; ?>
    	<?php if($key == "updateOtherEarningEntries"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
