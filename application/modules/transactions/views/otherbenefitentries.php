    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Other Benefit Entries <small>Manage Other Benefit Entries</small>
                </h2>
                
            </div>
            <div class="body">
                <div style="width:100%;padding-bottom:20px;" class="search_entry">
                    <?php if(Helper::role(ModuleRels::OTHER_BENEFITS_ADD_RECORDS)): ?> 
                    <div class="row">
                        <div class="col-md-2">
                            <a id="addOtherBenefitEntriesForm" class="btn btn-info btn-lg waves-effect" style="text-decoration:none;" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/addOtherBenefitEntriesForm'; ?>">
                    ...
                    <div class="row">
                       ...
                       <!--  <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <a id="searchEmployeeBenefit" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/' ?>">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/transactions/otherbenefitentries.js"></script>