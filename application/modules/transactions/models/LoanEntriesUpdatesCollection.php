<?php
	class LoanEntriesUpdatesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsloans_updates";   
      	var $order_column = array("(@cnt := @cnt)",
      							  "DECRYPTER(tblemployees.last_name,'sunev8clt1234567890',tblemployees.id)",
      							  'pay_basis',
      							  'tblfieldloans.description','tblfieldloanssub.description','loan_amount','loan_balance','amortization_per_month','rmtp','payroll_period',
