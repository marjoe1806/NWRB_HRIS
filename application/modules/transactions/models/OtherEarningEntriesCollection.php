<?php
	class OtherEarningEntriesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsotherearnings";   
      	var $order_column = array('','l_name','earning_description','amount','is_active','tblwebusers.username');
		...
		public function activeRows($params){
			...
			$code = "1";
			$message = "Other Earning failed to activate.";
			...
			if($this->db->affected_rows() > 0){
				$code = "0";
				$message = "Successfully activated Other Earning.";
		...
		public function inactiveRows($params){
			$helperDao = new HelperDao();
			$code = "1";
			$message = "Other Earning failed to deactivate.";
			$data['Id'] 	= isset($params['id'])?$params['id']:'';
			$data['Status'] 		= "0";
			$userlevel_sql = "	UPDATE ".$this->table." SET
									is_active = ? 
			...
			if($this->db->affected_rows() > 0){
				$code = "0";
				$message = "Successfully deactivated Other Earning.";
				$helperDao->auditTrails(Helper::get('userid'),$message);
				$this->ModelResponse($code, $message);
				return true;		
			}	
		...
		// 	$message = "Other Earning failed to insert.";
		// 	$this->db->insert($this->table, $params);
		// 	if($this->db->affected_rows() > 0)
		// 	{
		// 		$code = "0";
		// 		$message = "Successfully inserted Other Earning.";
		// 		$helperDao->auditTrails(Helper::get('userid'),$message);
		// 		$this->ModelResponse($code, $message);
		// 		return true;		
		// 	}	
		...
		// 	$helperDao = new HelperDao();
		// 	$code = "1";
		// 	$message = "Other Earning failed to update.";
		// 	$params['modified_by'] = Helper::get('userid');
		...
		// 	else {
		// 		$code = "0";
		// 		$message = "Successfully updated Other Earning.";
		// 		$helperDao->auditTrails(Helper::get('userid'),$message);
		// 		$this->ModelResponse($code, $message);
		// 		return true;	
		// 	}
