<?php
	class OvertimeApplicationsUpdatesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsovertimes_updates";   
      	var $order_column = array("(@cnt := @cnt)",
      							  ...
      							  "position_name",
      							  "salary","hrs_15","mins_15","hrs_125","mins_125","ot_percent","tax","tax_amt",
      							  "period_earned","net_pay","is_active","remarks","username","date_created","");
