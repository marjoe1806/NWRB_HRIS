<?php
	class PayrollPostingUpdatesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionspayrollposting_updates";   
      	var $order_column = array("(@cnt := @cnt)",
      							  "DECRYPTER(tblemployees.last_name,'sunev8clt1234567890',tblemployees.id)",
      							  "pay_basis",
      							  "days_count","lwp","lates","undertimes","pg_share","payroll_period",
