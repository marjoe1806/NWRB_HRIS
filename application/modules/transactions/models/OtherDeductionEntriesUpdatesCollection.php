<?php
	class OtherDeductionEntriesUpdatesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsotherdeductions_updates";   
      	var $order_column = array('(@cnt := @cnt)',
      							  'DECRYPTER(tblemployees.last_name,"sunev8clt1234567890",tblemployees.id)',
      							  'pay_basis',
      							  'period_id','deduct_description','amount','balance','amortization_per_month','rmtp',
