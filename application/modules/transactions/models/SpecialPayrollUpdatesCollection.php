<?php
	class SpecialPayrollUpdatesCollection extends Helper {
		...
		//Fetch
		var $table = "tbltransactionsbonus_updates";   
      	var $order_column = array("(@cnt := @cnt)",
      							  "DECRYPTER(tblemployees.last_name,'sunev8clt1234567890',tblemployees.id)",
      							  "pay_basis","payroll_grouping_code",
      	/*To Be Changed*/		  "bonus_type","amount","cash_gift","year",
		...
		{  
			...
			$this->select_column[] = 'tblfieldpayrollgrouping.code';
			$this->select_column[] = 'tblfieldpayrollgrouping.payroll_grouping_name';
			$this->select_column[] = 'tblfieldperiodsettings.period_id';
			$this->select_column[] = 'tblfieldbonuses.name';
		    ...
		    $this->db->select(
		    	...
		    	tblfieldpayrollgrouping.code AS payroll_grouping_code,
		    	tblfieldpayrollgrouping.payroll_grouping_name,
		    	tblfielddepartments.department_name,
		    	tblfieldbonuses.name AS bonus_name,
		    ...
		    $this->db->join("tblfieldbonuses",$this->table.".bonus_type = tblfieldbonuses.name","left");
