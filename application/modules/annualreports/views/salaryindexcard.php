    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Salary Index Card <small>Salary Index Card Summary</small>
                </h2>
            ...
            <div class="body">
                <div style="width:100%;padding-bottom:20px;" class="search_entry">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a id="computePayroll" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/' ?>" data-toggle="tooltip" data-placement="top" title="Search Salary Index Card">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/annualreports/salaryindexcard.js"></script>