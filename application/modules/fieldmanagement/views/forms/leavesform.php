    ...
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<textarea name="leave_name" rows="5" id="leave_name" class="required leave_name form-control" <?php echo $readonly ?>></textarea>
