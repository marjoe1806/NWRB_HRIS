	...
	<div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-6">
				...
				<div class="form-group">
					<div class="form-line">
						<input type="text" name="start_date" id="start_date" class="start_date form-control" required readonly="true">
					</div>
				</div>
			</div>
			<div class="col-md-6">
				...
				<div class="form-group">
					<div class="form-line">
						<input type="text" name="end_date" id="end_date" class="end_date form-control" required readonly="true">
					</div>
				</div>
			</div>
		</div>
