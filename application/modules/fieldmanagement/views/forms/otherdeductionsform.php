<?php 
	$readonly = "";
	if($key == "viewOtherDeductionsDetails")
		$readonly = "disabled";
?>
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                <label class="form-label">Deduct Code <span class="text-danger">*</span></label>
                <div class="form-group">
                	<div class="form-line">
                		<input type="text" name="deduct_code" id="deduct_code" class="deduct_code form-control" required <?php echo $readonly ?>>
                	</div>
            	</div>
            </div>
		</div>
    ...
    <div class="text-right" style="width:100%;">
    	...
    	<?php endif; ?>
    	<?php if($key == "updateOtherDeductions"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
