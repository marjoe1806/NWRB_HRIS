<?php 
	$readonly = "";
	if($key == "viewDocumentTypesDetails")
		$readonly = "disabled";
?>
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
                	<div class="form-line">
                		<input type="text" name="type_name" id="type_name" class="form-control" required <?php echo $readonly ?>>
                	</div>
            	</div>
            </div>
		</div>
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<textarea name="type_description" rows="5" id="type_description" class="form-control" <?php echo $readonly ?>></textarea>
    ...
    <div class="text-right" style="width:100%;">
    	...
    	<?php endif; ?>
    	<?php if($key == "updateDocumentTypes"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
