    ...
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<textarea name="department_name" rows="5" id="department_name" class="required department_name form-control" <?php echo $readonly ?>></textarea>
