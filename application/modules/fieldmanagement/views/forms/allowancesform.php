    ...
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<textarea name="allowance_name" rows="5" id="allowance_name" class="required allowance_name form-control" <?php echo $readonly ?>></textarea>
