<?php 
	$readonly = "";
	if($key == "viewContributionsGSISDetails")
		$readonly = "disabled";
?>
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                <label class="form-label">E.C. <span class="text-danger">*</span></label>
                <div class="form-group">
	                <div class="form-line">
	            		<input type="number" name="ec" id="ec" class="ec form-control" required <?php echo $readonly ?>>
	            	</div>
            	</div>
            </div>
		</div>
    ...
    <div class="text-right" style="width:100%;">
    	<?php if($key == "addContributionsGSIS"): ?>
    	...
    	<?php endif; ?>
    	<?php if($key == "updateContributionsGSIS"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
