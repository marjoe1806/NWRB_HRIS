<?php 
	$readonly = "";
	if($key == "viewLeaveGroupingDetails")
		$readonly = "disabled";
?>
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<textarea name="leave_grouping_name" rows="5" id="leave_grouping_name" class="required leave_grouping_name form-control" <?php echo $readonly ?>></textarea>
    ...
    <div class="text-right" style="width:100%;">
    	...
    	<?php endif; ?>
    	<?php if($key == "updateLeaveGrouping"): ?>
	        <button id="saveUserLevelConfig" class="btn btn-primary btn-sm waves-effect" type="submit">
