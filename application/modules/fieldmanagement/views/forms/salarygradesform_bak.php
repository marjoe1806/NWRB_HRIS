<?php
	$readonly = "";
	if($key == "viewSalaryGradesDetails")
		$readonly = "disabled";
?>
...
method="POST">
	<div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-12">
				<label class="form-label">Salary Grade
					<span class="text-danger">*</span>
				</label>
				<div class="form-group">
					<div class="form-line">
						<input type="text" name="salary_grade" id="salary_grade" class="salary_grade form-control" required <?php
						echo $readonly ?>>
					</div>
				</div>
			</div>
