...
<form id="<?php echo $key; ?>" action="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$key; ?>" method="POST">
    <div class="form-elements-container">
		...
		<div class="row clearfix">
			<div class="col-md-9">
                <label class="form-label">Bonus Title <span class="text-danger">*</span></label>
            ...
            <div class="col-md-3">
                <label class="form-label">With Tax <span class="text-danger">*</span></label>
                <div class="form-group">
                	<div class="form-line">
                		<select class="with_tax form-control " name="with_tax" id="with_tax" data-live-search="true">
		...
		<div class="row clearfix">
			<div class="col-md-6">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<select name="group" id="group" class="group form-control" <?php echo $readonly ?>>
			...
			<div class="col-md-6">
                ...
                <div class="form-group">
	                <div class="form-line">
	            		<input type="text" name="max" id="max" class="max currency form-control" required <?php echo $readonly ?>>
	            	</div>
            	</div>
            </div>
		</div>
