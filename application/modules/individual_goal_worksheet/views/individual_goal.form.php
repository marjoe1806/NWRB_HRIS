                ...
                <div class="card">
                    <div class = "body">
                        <div class="container-fluid">
                            ...
                            <table>
                                <tr>
                                    <td style="font-size: 12pt;width: 20% !important;">
                                        NAME:
                                        <select style="width: 70%; font-size: 15px;" id = "emp_name" class="employee_select" data-live-search="true"></select>
                                    </td>
                                    <td style="font-size: 9pt;width: 20% !important;" >
                                    ...
                                    <td style="font-size: 8pt;width: 20% !important;">
                    ...
                    <div class="card">
                        <div class="body">
                            <center>
                                ...
                                <small style="font-weight: bold;">
                                    8th Flr. NIA Building EDSA, Diliman, Quezon City
                                </small>
                            </center>
                            <table>
                                <tr>
                            ...
                            <table>
                                <tr>
                                    <td style="font-size: 9pt; width: 20% !important">
                                        NAME:
                                        <select id = "emp_name_display" class="employee_select" data-live-search="true" required></select>
                                    </td>
                                    <td style="font-size: 9pt; width: 20% !important">
...
<script type="text/javascript" src="<?php echo base_url();?>assets/local/module/js/worksheet/worksheet.js"></script> 
