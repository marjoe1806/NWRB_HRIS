	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header bg-blue">
				<h2>
					Daily Time Record Summary Report
			...
			<div class="body">
				<div style="width:100%; padding-bottom: 20px" class="search_entry">
					<div class="row">
						<div class="col-md-4">
							<h4 class="text-info">Division</h4>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/employees/dailytimerecordsummary.js"></script>
