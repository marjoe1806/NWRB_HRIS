    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-blue">
                <h2>
                    Travel Order Request <small>Manage Travel Order/s</small>
                </h2>
            ...
            <div class="body">
                <div class="row">
                        ...
                        <div class="col-md-3">
                            <a id="addTravelOrderForm" style="text-decoration:none;" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/addTravelOrderForm'; ?>">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/modules/js/travelorder/travelorder.js"></script>
